	...
	export default{
		...
		methods:{
			...
			goPin:function(orderid){
				uni.navigateTo({
					url:"../cy2c_pintuan/invite?orderid="+orderid
				})
			},
			getPage:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/cy2c_order/show?orderid="+this.orderid,
			...
			cancel:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/cy2c_order/cancel?orderid="+this.orderid,
					success:function(rs){
						that.getPage();
					}	
				})
			...
			receive:function(){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/cy2c_order/receive?orderid="+this.orderid,
					success:function(rs){
						that.getPage();
					}	
				})
			...
			goRaty:function(){
				uni.navigateTo({
					url:"../cy2c_order/raty?orderid="+this.orderid
				})
			},
			pay:function(){
				uni.navigateTo({
					url:"../cy2c_order/pay?orderid="+this.orderid
				})
			}
		}
	}
